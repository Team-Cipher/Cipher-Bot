Pokemon Showdown Bot for Node - By AlfaStorm and Stellation
====================
...
```
$ git clone --branch=master git://github.com/Team-Cipher/Cipher-Bot.git Pokemon-Showdown-Node-Bot
```
...
To configure your bot, copy `config-example.js` to `config.js` and edit that file. You can specify bot login credentials among other things. If you don't specify credentials, the bot will log in a random username started by 'Bot'. Read the [Configuration Guide](https://github.com/Team-Cipher/Cipher-Bot/blob/master/CONFIGGUIDE.md) for more information
...
```
git pull https://github.com/Team-Cipher/Cipher-Bot.git
```
...
Check the [configuration guide](https://github.com/Team-Cipher/Cipher-Bot/blob/master/CONFIGGUIDE.md) for more information.
...
-----------
 ...
 - [AlphaWind](https://github.com/AlphaWind/) (Owner)
 - [Stellation](https://github.com/Stellation/) (Owner)
